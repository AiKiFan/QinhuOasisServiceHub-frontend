...
async function handleUnfavorite(item) {
 ...
 restaurantFavorites.value = restaurantFavorites.value.filter(x => x.id !== item.id)
...
<template>
 ...
 <view class="favorite-card__actions" @tap.stop="handleUnfavorite({ type: 'restaurant', id: item.id })">
 ...
 <view class="favorite-card__actions" @tap.stop="handleUnfavorite({ type: 'interpreter', id: item.id })">
 <text class="favorite-card__star">★</text>
 </view>
 </view>
